...
We spend enormous energy agonising over active decisions. Should I take this job? Should we adopt this framework? Should I start that habit? Meanwhile, the defaults we inherited, accepted, or never questioned are quietly doing the heavy lifting - for better or worse.
...
I've seen this in professional services firms. The default billing model (hourly) doesn't just affect pricing - it shapes hiring, training, tooling decisions, and client relationships. Everything downstream bends to accommodate the default.
...
Most of the highest-leverage changes I've made - personally and professionally - haven't been dramatic decisions. They've been small adjustments to defaults. Changing the default meeting length. Changing the default communication channel. Changing what I reach for first thing in the morning. Changing the default question from "how do we do this?" to "should we do this at all?"
