...
The most important piece of economic research I've encountered on AI and work isn't from a think tank projecting job losses. It's from the [Dallas Federal Reserve](https://www.dallasfed.org/research/economics/2026/0224), published in February 2026.
...
Meanwhile, early-career workers aged 22 to 25 in the most AI-exposed occupations have experienced a [13% relative decline in employment](https://www.dallasfed.org/research/economics/2026/0106). Not through dramatic layoffs. Through quiet non-hiring.
...
The [IMF's January 2026 study](https://www.imf.org/en/publications/staff-discussion-notes/issues/2026/01/09/bridging-skill-gaps-for-the-future-new-jobs-creation-in-the-ai-age-572136) on AI and skill gaps found something that should concern anyone in a mid-tier cognitive role: AI-related skills offer wage premiums for high-skilled workers and sustain demand for low-skilled service work, but provide "no significant benefits for middle-skilled workers." The report explicitly warns this reinforces job polarisation and potentially contributes to the "shrinking of the middle class."
...
The [World Economic Forum](https://reports.weforum.org/docs/WEF_Future_of_Jobs_Report_2025.pdf) projects 170 million new roles created and 92 million displaced by 2030 — a net gain of 78 million jobs. [LinkedIn data](https://www.weforum.org/stories/2026/01/ai-has-already-added-1-3-million-new-jobs-according-to-linkedin-data/) shows AI has already added 1.3 million new positions globally. The job market isn't collapsing. But it is restructuring in ways that matter enormously if you're inside the transition.

The shift isn't from "human jobs" to "AI jobs." It's from *doing* to *orchestrating*.

Tim described this in [AI is simple](/2026/02/08/ai-is-simple/) — what he called the "operator skillset." Describing problems clearly. Evaluating output you didn't create. Comfort with iteration. These aren't AI skills. They're the skills of someone who directs work rather than executes it. The difference is that these skills used to be reserved for managers and architects. Now they're becoming the baseline expectation for everyone.

The [PwC 2025 AI Jobs Barometer](https://www.pwc.com/gx/en/news-room/press-releases/2025/ai-linked-to-a-fourfold-increase-in-productivity-growth.html) found that productivity growth nearly quadrupled in industries most exposed to AI — from 7% to 27% between 2018 and 2024. Individual workers are producing dramatically more output. That's the optimistic framing.
...
Tim can now [build software tools](/2026/01/08/ship-tomorrow/) that would have required a development team two years ago. One person, working from a terminal, producing working applications in an afternoon. That's individual empowerment. That's capability democratisation. That's exciting.

But zoom out and the same dynamic looks different. If one person can do what five did, four people lose their income. The productivity accrues to the person (or more precisely, to whoever owns the infrastructure the person is using). The [ILO found](https://www.ilo.org/publications/generative-ai-and-jobs-2025-update) that in high-income countries, 9.6% of female employment sits in the highest-risk category for AI automation — nearly three times the share for men. The burden isn't distributed evenly across gender, age, geography, or class.

Professionals with AI skills now command a [56% wage premium](https://www.pwc.com/gx/en/services/ai/ai-jobs-barometer.html) over their peers. The college wage premium — the economic reward for getting a degree — has flattened since roughly 2010. AI literacy is replacing institutional credentials as the signal employers pay for.

In Australia specifically, the picture has its own texture. The [Tech Council of Australia](https://techcouncil.com.au/newsroom/new-report-shows-aussies-embracing-ai-in-the-workplace/) found 93% of workers believe AI will augment rather than replace their jobs. But [DISR figures](https://employmenthero.com/news/australia-tech-job-decline-ai-impact/) show the Australian tech sector shrank by 31,000 jobs — 3.7% — in the year to May 2025. People are optimistic about AI's impact on their own role while the sector is already contracting. Both things are true. Neither cancels the other out.
...
Build your [foundations](/2026/02/26/the-messy-middle/) before worrying about the technology. The messy middle applies to careers as much as businesses. The person who understands their domain deeply, has their processes mapped, and can articulate what they actually do — that person will adapt. The person whose value proposition was "I know how to operate this specific software" is in trouble.

And be honest about the uncertainty. The [WEF's projection](https://reports.weforum.org/docs/WEF_Future_of_Jobs_Report_2025.pdf) of 78 million net new jobs by 2030 might be right. [Acemoglu's conservative estimate](https://sloanreview.mit.edu/audio/ai-is-not-improving-productivity-nobel-laureate-daron-acemoglu/) of 4.6% of tasks actually being automated might be right. [Goldman Sachs saying](https://fortune.com/2026/03/03/goldman-earnings-ai-anxiety-no-meaningful-impact-productivity-economy-30-percent-in-2-areas/) AI has contributed "basically zero" to GDP growth so far while projecting 7% growth long-term might be right. These aren't contradictions — they're different time horizons, different methodologies, different assumptions. Anyone claiming certainty about how this unfolds is selling something.
...
Tim is in Thailand, probably reading this on his phone while his kids play in the pool. He has the operator skillset, the domain expertise, and the temperament to thrive in whatever comes next. Most people reading this probably do too — self-selection bias means you're already paying attention.

But "the people paying attention will be fine" isn't a sufficient answer when the people who aren't paying attention — or who are paying attention but lack the resources to adapt — number in the hundreds of millions.
